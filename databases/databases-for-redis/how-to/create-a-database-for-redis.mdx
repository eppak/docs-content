...
1. Click **Databases for Redis™** under **Databases** on the side menu. If you do not have a database already created, the creation page displays.
...
<Navigation title="See Also">
  <NextButton to="/databases/databases-for-redis/how-to/manage-allowed-ip-addresses-redis">How to manage allowed IPs</NextButton>
</Navigation>
